...
const Dashboard = ({ className = false }) => {
  const latestData = [
    ...
    { date: '20/07', description: 'NETFLIX 235236', value: '55,00' },
  ...
  const futureData = [
    ...
    { date: '21/08', description: 'IMAGINE 02323626', value: '300,00' },
    { date: '20/08', description: 'NETFLIX 235236', value: '55,00' },
      ...
      <Row>
        <Col xs={12} lg={4}>
          <Row className='align-items-center mb-5'>
            ...
            <Col xs={9}>
              <h4>Icaro Melchior Barbosa</h4>
              <p className='text-muted'>ag: 5815 c/c: 14021-4</p>
            </Col>
          </Row>
          <Button
